...
class important extends connector {
	...
	function onmembersave() {
		...
		if (!preg_match("/^1[0-9]{10}$/i", $username)) {
			exit('false');
		}
		...
		if ($inputclass == 'add') {
			...
			$db_field = 'username,password,email,question,answer,sex,birthday,country,province,city,district,alias,address,zipcode,tel,mobile,qq,msn,integral,visitcount,lastip,addtime,lasttime,mcid,isclass,ismoblie';
			$db_values = "'$username','$password','$email','$question','$answer',$sex,$birthday,$country,$province,$city,$district,'$alias','$address',$zipcode,'$tel','$mobile',$qq,'$msn',$integral,0,0,$date,$date,$mcid,$isclass,1";
