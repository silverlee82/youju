...
<script type="text/javascript">
	...
	var memattmanage_js_add_ok = "<?php echo $this->_tpl_vars['ST']['memattmanage_js_add_ok'] ?>";
	var memattmanage_js_add_no = "<?php echo $this->_tpl_vars['ST']['memattmanage_js_add_no'] ?>";
...
<input type="hidden" name="tab" id="memattraddtab" value="<?php echo $this->_tpl_vars['tab'] ?>">
<div id="mainbodybottonauto" class="managebottonadd">
	<div class="maindobycontent">
		<div class="suggestion">
			<span class="sugicon"><span class="strong colorgorning2"><?php echo $this->_tpl_vars['ST']['position_title'] ?></span><span class="colorgorningage"><?php echo $this->_tpl_vars['ST']['memattmanage_add_mess'] ?></span></span>
		</div>
			...
			<div class="maneditcontent">
				<table class="formtable">
					...
					<tr class="trstyle2">
						...
						<td class="trtitle02"><span class="cautiontitle"><?php echo $this->_tpl_vars['ST']['memattmanage_attr_add_typename_mess'] ?></span></td>
					</tr>
					<tr class="trstyle2">
					...
					<tr class="trstyle2">
						...
						<td class="trtitle02">
							<input type="text" name="attrname" size="25" maxlength="50"  class="infoInput"  onblur="checktypename('attrname',this.value,'index.php?archive=memattmanage&action=checkattrname&inputtype='+document.memattradd.inputtype.value,'attrnameerr','<?php echo $this->_tpl_vars['ST']['modelmanage_js_attr_input_ok'] ?>','<?php echo $this->_tpl_vars['ST']['modelmanage_js_attr_input_no'] ?>','attrsubmitbotton');"/>
					...
					<tr class="trstyle2">
						<td class="trtitle01"></td>
						<td class="trtitle02"><span class="cautiontitle"><?php echo $this->_tpl_vars['ST']['memattmanage_attr_add_typeremark_mess'] ?></span></td>
					</tr>
					<tr class="trstyle3">
					...
					<tr class="trstyle2">
						...
						<td class="trtitle02">
							...
							<span class="cautiontitle"><?php echo $this->_tpl_vars['ST']['memattmanage_add_class_mess'] ?></span>
						</td>
					</tr>
				</table>
			</div>
