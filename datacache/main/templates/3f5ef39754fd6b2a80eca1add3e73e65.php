		...
		<div class="espcms_book_paddingbottom0 pt10">
			<div class="espcms_bbs_form">
				...
				<div class="content">
					...
					<?php if($this->_tpl_vars['read']['shippingmoney']>0){ ?>
					<div class="espcms_form_group">
						<label for="shippingmoney" class="control_label">运送费用</label>
						<div class="control_required f14"><?php echo $this->_tpl_vars['moneytype'] ?><?php echo $this->_tpl_vars['read']['shippingmoney'] ?></div>
					</div>
					<?php } ?>
					...
					<div class="espcms_form_group">
						...
						<div class="control_required f14">商品总额<?php echo $this->_tpl_vars['moneytype'] ?><?php echo $this->_tpl_vars['read']['productmoney'] ?> - 折扣<?php echo $this->_tpl_vars['moneytype'] ?><?php echo $this->_tpl_vars['read']['discount'] ?> + 运费<?php echo $this->_tpl_vars['moneytype'] ?><?php echo $this->_tpl_vars['read']['shippingmoney'] ?> + 支付手续费<?php echo $this->_tpl_vars['moneytype'] ?><?php echo $this->_tpl_vars['read']['paymoney'] ?> = 订单总额<?php echo $this->_tpl_vars['moneytype'] ?><?php echo $this->_tpl_vars['read']['orderamount'] ?></div>
					</div>
					<?php if($this->_tpl_vars['read']['paytime']>0){ ?>
					<div class="espcms_form_group">
						<label for="payname" class="control_label">支付方式</label>
						<div class="control_required f14"><?php echo $this->_tpl_vars['pay']['payname'] ?></div>
					</div>
					<div class="espcms_form_group">
						<label for="paysn" class="control_label">支付凭证号</label>
						<div class="control_required f14"><?php echo $this->_tpl_vars['read']['paysn'] ?></div>
					</div>
					<div class="espcms_form_group">
						<label for="paytime" class="control_label">支付时间</label>
						<div class="control_required f14"><?php echo $this->timeformat($this->_tpl_vars['read']['paytime'],4) ?></div>
					</div>
					<?php }else{ ?>
					<div class="espcms_form_group"><?php echo $this->_tpl_vars['orderonline'] ?></div>
					<?php } ?>
				</div>
				<?php if($this->_tpl_vars['read']['ordertype']==1 || $this->_tpl_vars['read']['ordertype']==2){ ?>
				<div class="title"><div class="messageicon3"></div><div class="messtitle">收货信息修改</div></div>
				<div class="content">
					<form name="ordersaveform" method="post" action="<?php echo $this->_tpl_vars['mlink']['ordereditsave'] ?>" onsubmit="return ordersave()">
					<input type="hidden" name="tokenkey" value="<?php echo $this->_tpl_vars['tokenkey']['token_key'] ?>"/>
					<input type="hidden" name="oid" value="<?php echo $this->_tpl_vars['read']['oid'] ?>"/>
					<input type="hidden" name="email" value="<?php echo $this->_tpl_vars['read']['email'] ?>"/>
					<div class="espcms_form_group">
						<label for="alias" class="control_label">收件人</label>
						<div class="control_required"><input type="text" name="alias" value="<?php echo $this->_tpl_vars['read']['consignee'] ?>" maxlength="50" size="30" class="infoInput"/></div>
					</div>
					<div class="espcms_form_group">
						<label for="email" class="control_label">电子邮箱</label>
						<div class="control_required f14"><?php echo $this->_tpl_vars['read']['email'] ?></div>
					</div>
					<div class="espcms_form_group">
						<label for="tel" class="control_label">联系电话</label>
						<div class="control_required"><input type="text" name="tel" value="<?php echo $this->_tpl_vars['read']['tel'] ?>" maxlength="20" size="30" class="infoInput"/></div>
					</div>
					<div class="espcms_form_group">
						<label for="mobile" class="control_label">手机</label>
						<div class="control_required"><input type="text" name="mobile" value="<?php echo $this->_tpl_vars['read']['mobile'] ?>" maxlength="15" size="30" class="infoInput"/></div>
					</div>
					<?php if($this->_tpl_vars['mem_isaddress']==1){ ?>
					<div class="espcms_form_group">
						<label for="cityone" class="control_label">地区</label>
						<div class="control_required">
							<select size="1" name="cityone" class="infoInput" id="cityone">
							    <option value="0" <?php if($this->_tpl_vars['read']['country']==0){ ?>selected<?php } ?>>国家</option>
							    <option value="1" <?php if($this->_tpl_vars['read']['country']==1){ ?>selected<?php } ?>>中国</option>
							</select>
							<select size="1" name="citytwo" class="infoInput" id="citytwo">
							    <option selected value="0">省</option>
							</select>
					...
					<div class="espcms_form_group">
						<label for="address" class="control_label">详细地址</label>
						<div class="control_required"><input type="text" name="address" value="<?php echo $this->_tpl_vars['read']['address'] ?>" maxlength="200" size="60" class="infoInput"/></div>
					</div>
					<div class="espcms_form_group">
						<label for="zipcode" class="control_label">邮编</label>
						<div class="control_required"><input type="text" name="zipcode" value="<?php echo $this->_tpl_vars['read']['zipcode'] ?>" maxlength="10" size="10" class="infoInput"/></div>
					</div>
					<div class="espcms_form_group">
						<label for="sendtime" class="control_label">送货时间</label>
						<div class="control_required">
							<select size="1" name="sendtime" class="infoInput">
							    <option value="1" <?php if($this->_tpl_vars['read']['sendtime']==1){ ?>selected<?php } ?>>工作日、双休日与假日均可送货</option>
							    <option value="2" <?php if($this->_tpl_vars['read']['sendtime']==2){ ?>selected<?php } ?>>只双休日、假日送货(工作日不用送)</option>
							    <option value="3" <?php if($this->_tpl_vars['read']['sendtime']==3){ ?>selected<?php } ?>>只工作日送货(双休日、假日不用送)</option>
							    <option value="4" <?php if($this->_tpl_vars['read']['sendtime']==4){ ?>selected<?php } ?>>尽量安排其他时间送货,请备注说明</option>
							</select>
						</div>
					</div>
					<div class="espcms_form_group">
						<label for="shippingtime" class="control_label">配送方式</label>
						<div class="control_required">
							<?php echo $this->_tpl_vars['shiping']['title'] ?>
							<?php if($this->_tpl_vars['read']['shippingtime']==0){ ?>
							<font color="red"><b>未送货</b></font>
							<?php }else{ ?>
							<font color="#008A00">已送货</font>&nbsp;&nbsp;
							<b>物流单号：</b><u><?php echo $this->_tpl_vars['read']['shippingsn'] ?></u>&nbsp;&nbsp;
							<b>发货时间：</b><u><?php echo $this->timeformat($this->_tpl_vars['read']['shippingtime'],4) ?></u>
							<?php } ?>
						</div>
					</div>
					<div class="espcms_form_group">
						<label for="content" class="control_label">备注</label>
						<div class="control_required">
							<textarea name="content" rows="5" cols="50" class="col11 infoInput"><?php echo $this->_tpl_vars['read']['content'] ?></textarea>
						</div>
					</div>
					<div class="espcms_form_group">
						<label for="email" class="control_label"></label>
						<div class="control_required">
							<input type="submit" id="submit" class="button blue2" value="修改订单联系信息"/>
						</div>
					</div>
				</div>
				</form>
				<?php }else{ ?>
				<div class="title"><div class="messageicon3"></div><div class="messtitle">收货信息</div></div>
				<div class="content">
					<div class="espcms_form_group">
						<label for="email" class="control_label">收件人</label>
						<div class="control_required f14"><?php echo $this->_tpl_vars['read']['consignee'] ?></div>
					</div>
					<div class="espcms_form_group">
						<label for="email" class="control_label">电子邮箱</label>
						<div class="control_required f14"><?php echo $this->_tpl_vars['read']['email'] ?></div>
					...
					<?php if($this->_tpl_vars['mem_isaddress']==1){ ?>
					<div class="espcms_form_group">
						<label for="email" class="control_label">地区</label>
						<div class="control_required f14">
							<select size="1" name="cityone" class="infoInput" id="cityone" disabled>
							    <option value="0" <?php if($this->_tpl_vars['read']['country']==0){ ?>selected<?php } ?>>请选择国家</option>
							    <option value="1" <?php if($this->_tpl_vars['read']['country']==1){ ?>selected<?php } ?>>中国</option>
							</select>
							<select size="1" name="citytwo" class="infoInput" id="citytwo" disabled>
							    <option selected value="0">请选择省份</option>
							</select>
							<select size="1" name="citythree" class="infoInput" id="citythree" disabled>
							    <option selected value="0">请选择城市</option>
							</select>
							<select size="1" name="district" class="infoInput" id="district" disabled>
					...
					<?php } ?>
					<div class="espcms_form_group">
						<label for="email" class="control_label">详细地址</label>
						<div class="control_required f14"><?php echo $this->_tpl_vars['read']['address'] ?></div>
					</div>
					<?php if($this->_tpl_vars['read']['zipcode']){ ?>
					<div class="espcms_form_group">
						<label for="email" class="control_label">邮编</label>
						<div class="control_required f14"><?php echo $this->_tpl_vars['read']['zipcode'] ?></div>
					</div>
					<?php } ?>
					<div class="espcms_form_group">
						<label for="email" class="control_label">联系电话</label>
						<div class="control_required f14"><?php echo $this->_tpl_vars['read']['tel'] ?></div>
					</div>
					<div class="espcms_form_group">
						<label for="email" class="control_label">手机</label>
						<div class="control_required f14"><?php echo $this->_tpl_vars['read']['mobile'] ?></div>
					</div>
					<div class="espcms_form_group">
						<label for="email" class="control_label">送货时间</label>
						<div class="control_required f14"><?php if($this->_tpl_vars['read']['sendtime']==1){ ?>工作日、双休日与假日均可送货<?php } ?><?php if($this->_tpl_vars['read']['sendtime']==2){ ?>工只双休日、假日送货(工作日不用送)<?php } ?><?php if($this->_tpl_vars['read']['sendtime']==3){ ?>只工作日送货(双休日、假日不用送)<?php } ?><?php if($this->_tpl_vars['read']['sendtime']==4){ ?>尽量安排其他时间送货,请备注说明<?php } ?></div>
					</div>
					<div class="espcms_form_group">
						<label for="email" class="control_label">配送方式</label>
						<div class="control_required f14">
							<?php echo $this->_tpl_vars['shiping']['title'] ?>
							<?php if($this->_tpl_vars['read']['shippingtime']==0){ ?>
							<font color="red"><b>未送货</b></font>
				...
				<?php } ?>
				<div class="title"><div class="messageicon3"></div><div class="messtitle">其它信息</div></div>
				<div class="content">
					<?php if($this->_tpl_vars['read']['invpayee']){ ?>
					<div class="espcms_form_group">
						<label for="email" class="control_label">发票抬头</label>
						<div class="control_required f14"><?php echo $this->_tpl_vars['read']['invpayee'] ?></div>
					</div>
					<?php } ?>
					<?php if($this->_tpl_vars['read']['invcontent']){ ?>
					<div class="espcms_form_group">
						<label for="email" class="control_label">发票内容</label>
						<div class="control_required f14"><?php echo $this->_tpl_vars['read']['invcontent'] ?></div>
					</div>
					<?php } ?>
					<?php if($this->_tpl_vars['read']['content']){ ?>
					<div class="espcms_form_group">
						<label for="email" class="control_label">备注</label>
						<div class="control_required f14"><?php echo $this->_tpl_vars['read']['content'] ?></div>
					</div>
					<?php } ?>
					<?php if($this->_tpl_vars['read']['integral']>0){ ?>
					<div class="espcms_form_group">
						<label for="email" class="control_label">该订单所得积分</label>
						<div class="control_required f14"><?php echo $this->_tpl_vars['read']['integral'] ?></div>
					</div>
					<?php } ?>
				</div>
				<b class="b5"></b><b class="b6"></b><b class="b7"></b><b class="b8"></b>
