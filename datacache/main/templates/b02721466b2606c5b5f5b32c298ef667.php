...
<div class="espcms_page espcms_page_left_linkbg">
	...
	<div class="espcms_page_right">
		...
		<div class="espcms_news_title">
			<h1><?php echo $this->_tpl_vars['read']['title'] ?></h1>
		...
		<div class="espcms_page_right_line"></div>
		<div class="espcms_book lh26 ti2"><?php echo $this->_tpl_vars['read']['content'] ?></div>

		<?php if($this->_tpl_vars['read']['fgid']!=0){ ?>
		<div class="espcms_book pb20">
			6623ef97c6f6ccf2fb032e800d2edda9form|fgid:<?php echo $this->_tpl_vars['read']['fgid'] ?>,did:<?php echo $this->_tpl_vars['read']['did'] ?>,mid:<?php echo $this->_tpl_vars['read']['mid'] ?>||||6623ef97c6f6ccf2fb032e800d2edda9
		</div>
		<?php } ?>
	</div>
</div>
